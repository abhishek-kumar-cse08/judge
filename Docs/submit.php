...
<?php 
    function query( $code, $admin ){
		...
		if( mysql_num_rows( $result ) == 0 ){
			echo 'Question does not exist or the solution to it can not be submitted now.';
			return FALSE;
		}
    ...
    if( !isset( $_SESSION["username"] ) ){
		...
		echo '<form action="serve_submit.php" id="form" method="post" enctype="multipart/form-data">';
