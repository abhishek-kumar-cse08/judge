...
<?php
	...
	function check_insert( $admin, $code, $name, $statement, $time, $languages, $file, $judge, $question_display, $submission_display ){
		...
		$sql = "UPDATE questions SET name='".$name."', statement='".$statement."', time='".$time."', languages='".$languages."', file='".$file."', judge='".$judge.
		"', question_time = ".$question_time.", submission_time = ".$submission_time." WHERE code='".$code."' AND admin='".$admin."' ";
